...
function tambahMenu($idPelanggan, $menu)
{
    ...
    $idPelanggan = $conn->real_escape_string($idPelanggan);
    $menu = $conn->real_escape_string($menu);


    // Query untuk menambahkan data menu baru
    $sql = "INSERT INTO `pesan` (`idPelanggan`, `idMenu`, `namaMenu`, `harga`) 
        SELECT '$idPelanggan', idMenu, namaMenu, harga FROM menu WHERE idMenu = '$menu'";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header("Location: waiter.php?error=2");
        exit();
    }
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="waiter.php" class="btn btn-danger btn-block mt-3">BATAL</a>
